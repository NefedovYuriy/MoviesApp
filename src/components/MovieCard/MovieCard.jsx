...
export class MovieCard extends Component {
  render() {
    ...
    const posterIMG = (poster) => {
      const defaultImage =
        'https://publicimagedata.s3.amazonaws.com/stable_diffusion_thumbnail/1/hyper_realistic_oil_painting_movie_poster_of_a_fat_toad_wearing_anaglyph_red_-_blue_glasses_with_popcorn_pot_vibrant_colors_high_contrast_-H_640_-C_10.0_-n_9_-i_-S_2866264059_ts-1660401670_idx-4_thum';
